        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-base md:text-lg text-gray-700 max-w-2xl mx-auto">
              Explore a wide range of printing services to suit your textile
              needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-white p-6 pb-12 rounded-lg shadow hover:shadow-lg transition text-center relative">
              <h3 className="text-lg font-bold text-[#7B1451] mb-3">
                Digital Printing
              </h3>
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              />
              <div>
                <h2 className="text-2xl font-bold text-[#7B1451] mb-3">
                  Digital Printing
                </h2>
                <p className="text-gray-700 mb-3">
                  Digital fabric printing is a process that involves printing
                  digital images directly onto fabric using inkjet technology.
                </p>
                <p className="text-sm text-[#ECB922] font-bold">
                  <span className="font-bold">Graphics required:</span> Files
                  should be in <span>.TIFF / .PNG / Digitally created</span>.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">
                  Sublimation printing is a digital printing technology that
                  uses heat to transfer dye into synthetic fabrics.
                </p>
                <p className="text-sm text-[#ECB922] font-bold">
                  <span className="font-bold">Graphics required:</span> Use
                  high-resolution <span>.JPG / .PNG</span> files.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-3">
                  Digital screen printing is a hybrid screen printing technology
                  that combines traditional techniques with digital printing for
                  precision.
                </p>
                <p className="text-sm text-[#ECB922] font-bold">
                  <span className="font-bold">Graphics required:</span> Files
                  should be in <span>.AI / .EPS / Digitally created</span>.
                </p>
              </div>
            </div>
          </div>
